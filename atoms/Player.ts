...
const VideoMetadataAtom = atom<VideoMetadata>({currentTime:0,duration:0,paused:false,isLoading:true});

const PlayerConfigAtom = atomWithStorage<PlayerConfig>("playerConfig",{playbackRate: 1,windowFullscreen:true,autoPlay:true,isTheatre:false,isFullscreen: false,isHls:true,isPipEnable:false,volume:1});
